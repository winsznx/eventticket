...
contract UeventticketTest is Test {
    Ueventticket public registry;
    ...
    function testCannotRegisterDuplicateName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Ueventticket.NameAlreadyRegistered.selector);
        registry.registerName("alice");
    }
    ...
    function testCannotTransferUnownedName() public {
        ...
        vm.prank(user2);
        vm.expectRevert(Ueventticket.NotNameOwner.selector);
        registry.transferName("alice", user2);
    }
    ...
    function testInvalidNameLength() public {
        vm.prank(user1);
        vm.expectRevert(Ueventticket.InvalidName.selector);
